...
$GLOBALS['FW_URL_OLD'] = 'http://localhost/rosewell';
$GLOBALS['FW_URL_NEW'] = 'http://www.rosewellmusic.com';
$GLOBALS['FW_PACKAGE_NAME'] = '20140308_rosewellmusicschool_531ac3c491a493196140308071620_archive.zip';
$GLOBALS['FW_PACKAGE_NOTES'] = '';
$GLOBALS['FW_SECURE_NAME'] = '20140308_rosewellmusicschool_531ac3c491a493196140308071620';
$GLOBALS['FW_DBHOST'] = 'localhost';
$GLOBALS['FW_DBHOST'] = empty($GLOBALS['FW_DBHOST']) ? 'localhost' : $GLOBALS['FW_DBHOST'];
$GLOBALS['FW_DBNAME'] = 'rosewellmusic';
$GLOBALS['FW_DBUSER'] = 'rosewellmusic';
$GLOBALS['FW_DBPASS'] = '';
$GLOBALS['FW_SSL_ADMIN'] = 0;
$GLOBALS['FW_SSL_LOGIN'] = 0;
$GLOBALS['FW_CACHE_WP'] = 0;
$GLOBALS['FW_CACHE_PATH'] = 0;
$GLOBALS['FW_BLOGNAME'] = 'Rosewell - music school';
$GLOBALS['FW_WPROOT'] = '/Applications/MAMP/htdocs/rosewell/';
