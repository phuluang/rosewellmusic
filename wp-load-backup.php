<?php
define("EXE_START_TIME",microtime(true));
function get_execution_time($exit=true){
	$text="Under maintenance. Please come back later";
	echo $text." (". (microtime(true)-EXE_START_TIME) .")";
	if($exit){
	exit();
	}
}
